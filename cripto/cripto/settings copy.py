...
SECRET_KEY = 'django-insecure-oa@^t@55l395pof3ax#zyatx#n%e@7+occcupd5_6+_n41&_a('
...
DATABASES = {
    'default': {
        ...
        'PORT': '',           # Deja en blanco para usar el puerto predeterminado de MySQL
    }
}
...
STATIC_URL = 'static/'
# Ruta al directorio de archivos de medios
